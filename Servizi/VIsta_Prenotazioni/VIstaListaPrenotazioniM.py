...
from Servizi.VIsta_Prenotazioni.Vista_Info_Prenotazione.VistaInfoPrenotazioneM import VistaInfoPrenotazioniM
from Servizi.Prenotazione import Prenotazione


class VistaListaPrenotazioniM(QWidget):
    def __init__(self, parent=None):
        super(VistaListaPrenotazioniM, self).__init__(parent)
    ...
    def go_info_prenotazione(self):
        try:
            ...
            self.vista_info = VistaInfoPrenotazioniM(prenotazione)
